<?php
    ...
    class M_Product {
        ...
        public function Add_Prd($name, $brand, $price, $sale, $color, $sex, $size, $alias,$arr_img, $info){
            $isOk = false;
            $sql = "INSERT INTO watch (name_watch, brand_id, price_watch, sale_watch, size_watch, color_watch, sex_watch, info_watch, alias_watch)
            VALUES ('$name', '$brand', '$price', '$sale', '$size', '$color', '$sex','$info', '$alias')";
        ...
        public function Update_Prd($id, $name, $brand, $price, $sale, $color, $sex, $size, $info){
            $sql = "UPDATE watch
            SET name_watch = '$name', brand_id = '$brand', price_watch = '$price', sale_watch = '$sale',
                size_watch = '$size', color_watch = '$color', sex_watch = '$sex', info_watch = '$info'
                WHERE id_watch = '$id'";
        ...
        public function UpdateImgPrd($id_img, $img_data){
        ...
        public function GetAllPrdCustom($limit = 6, $from = 0, $choose = "sale_watch", $filter = "DESC", $where_w = ""){
            $sql = "select *, GROUP_CONCAT(img_watch.id_img,':',img_watch.content_img) as Array_Img
					from  brand, sex,watch
					INNER JOIN img_watch ON watch.id_watch = img_watch.id_watch
					$where_w
