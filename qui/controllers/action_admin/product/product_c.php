<?php
    ...
    class ShowAdminAddPrd{
        ...
        public function AddAdminPrd($name, $brand, $price, $sale, $color, $sex, $size, $alias, $info, $ksu){
            $main = new M_Product();
            if($name != "" && $price != ""){
                ...
                if(count($mangFile['name']) > 0 && $mangFile['name'][0] != NULL){
                    ...
                    if(count($mangFile['name']) == 1 && $mangFile['name'][0] == NULL ){
                        $main->Add_Prd($name, $brand, $price, $sale, $color, $sex, $size, $alias, $arr_img, $info, $ksu);
                    }
                }
                if($isOk){
                    $main->Add_Prd($name, $brand, $price, $sale, $color, $sex, $size, $alias, $arr_img, $info, $ksu);
        ...
        public function UpdateAdminPrd($id, $name, $brand, $price, $sale, $color, $sex, $size, $info, $ksu, $on_off_sp, $alias){
            $main = new M_Product();
            $main->Update_Prd($id, $name, $brand, $price, $sale, $color, $sex, $size, $info, $ksu, $on_off_sp, $alias);
            //echo $id."<br>".$name;
        }
